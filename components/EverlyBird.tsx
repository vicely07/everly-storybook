...
export const EverlyBird: React.FC<EverlyBirdProps> = ({ size = 64, className = '', talking = false }) => {
  return (
    <div className={`relative flex items-center justify-center ${className}`} style={{ width: size, height: size }}>
      ...
      >
        <defs>
          {/* 1. Primary Teal Gradient - Deep and Rich */}
          <radialGradient id="tealGradient" cx="50%" cy="50%" r="50%" fx="30%" fy="30%">
            <stop offset="0%" stopColor="#2dd4bf" stopOpacity="0.9" /> {/* Teal-400 */}
            <stop offset="60%" stopColor="#0d9488" stopOpacity="0.6" /> {/* Teal-600 */}
            <stop offset="100%" stopColor="#0f766e" stopOpacity="0" />   {/* Teal-700 */}
          </radialGradient>
          
          {/* 2. Secondary Violet Gradient - Replaces Emerald */}
          <radialGradient id="violetGradient" cx="50%" cy="50%" r="50%" fx="70%" fy="70%">
            <stop offset="0%" stopColor="#a78bfa" stopOpacity="0.9" /> {/* Violet-400 */}
            <stop offset="60%" stopColor="#7c3aed" stopOpacity="0.6" /> {/* Violet-600 */}
            <stop offset="100%" stopColor="#4c1d95" stopOpacity="0" />   {/* Violet-900 */}
          </radialGradient>
        ...
        {talking && (
          <g style={{ transformOrigin: '50px 50px' }}>
            <circle cx="50" cy="50" r="20" stroke="#2dd4bf" strokeWidth="4" fill="none" opacity="0.9">
             ...
             <circle cx="50" cy="50" r="20" stroke="#a78bfa" strokeWidth="3" fill="none" opacity="0.7">
